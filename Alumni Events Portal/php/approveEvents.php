...
This file allows the alumnioffice to approve pending events 
...
$query4 = oci_parse($conn, "insert into alumnievents (eventsid, eventname, firstname, lastname, gradyear, major, location, eventdate, eventsdescription) select eventsid, eventname, firstname, lastname, gradyear, major, location, eventdate, eventsdescription from pendingevents where pendingevents.eventsid = '$a'");
oci_execute($query4);
