...
This file checks to see whether or not the user is an alumni by checking to see if the info provided
is in the alumni database.

If true, then the event is added to a list of pending events to approved later.
Otherwise, event is not added.
